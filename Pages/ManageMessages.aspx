<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageMessages.aspx.cs" Inherits="Narrativa.Pages.ManageMessages" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Narrativa - Manage Messages</title>
...
<form id="form1" runat="server">
    ...
    <div class="page">
        ...
        <div class="card">
            ...
            <p class="subtitle">View and manage messages sent from the contact page.</p>
            ...
            <asp:GridView ID="gvMessages" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Message">
                        <ItemTemplate>
                            <div class="message-text"><%# Eval("Message") %>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:BoundField DataField="CreatedAt" HeaderText="Date" DataFormatString="{0:yyyy-MM-dd}" />
                    <asp:ButtonField Text="Delete" CommandName="DeleteMessage" ButtonType="Link" />
                </Columns>
